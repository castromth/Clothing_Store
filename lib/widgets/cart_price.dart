      ...
      child: Container(
        ...
        child: ScopedModelDescendant<CartModel>(
          builder: (context,child,model){
            ...
            double discount = model.getProductsDiscount();
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text("R\$ ${(price-discount+ship).toStringAsFixed(2)}", style:TextStyle(color: Theme.of(context).primaryColor, fontSize: 16.0))
                  ],
                ),
                SizedBox(height: 16.0),
                RaisedButton(
